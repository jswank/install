...
Usage: $this [-b bindir] [-d] [-q] [-n] [tag]
  ...
  -n turns on dry run mode
   ...
   If tag is missing, then v3.6b will be used.
...
EMBEDDED_CHECKSUMS="
3.6b:tmux-3.6b-linux-arm64.tar.gz:fd4a2206c5e468dd2ee4e9a65f2d40e0762551965d7fdbe849c494ab14f513e9
3.6b:tmux-3.6b-linux-x86_64.tar.gz:002a6f4fd52212600fa0d72d865dcf328e5b8b6e83c179788144d8587b75677a
3.6b:tmux-3.6b-macos-arm64.tar.gz:88323402bd28d21103239caf009b130086ebf334807de485d4a1e1c7188ee810
3.6b:tmux-3.6b-macos-x86_64.tar.gz:073f6e2c2baa7eb5d643563600ee6052ca8619f3ec5a0cfdf99c56397fb72c94"
...
resolve_asset_filename() {
  ...
  if [ -z "${ASSET_FILENAME}" ]; then
    ASSET_FILENAME="tmux-${VERSION}-${OS}-${ARCH}${EXT}"
  fi
}
