...
EMBEDDED_CHECKSUMS="
1.3.1:age-v1.3.1-darwin-amd64.tar.gz:2b233301ad21ab7b1eabd9ae1198a164005fa4928fcdd745d47c39f8593209d7
1.3.1:age-v1.3.1-darwin-arm64.tar.gz:01120ea2cbf0463d4c6bd767f99f3271bbed1cdc8a9aa718a76ba1fe4f01998b
1.3.1:age-v1.3.1-freebsd-amd64.tar.gz:3d597b093d6b21f78b465a55cef748cdd357bddc43128527d3aacec4649caa63
1.3.1:age-v1.3.1-linux-amd64.tar.gz:bdc69c09cbdd6cf8b1f333d372a1f58247b3a33146406333e30c0f26e8f51377
1.3.1:age-v1.3.1-linux-arm.tar.gz:0af5d0dd1664d43dda955938280a668fdd298ad0df90058b409067dfdec74ba3
1.3.1:age-v1.3.1-linux-arm64.tar.gz:c6878a324421b69e3e20b00ba17c04bc5c6dab0030cfe55bf8f68fa8d9e9093a
1.3.1:age-v1.3.1-windows-amd64.zip:c56e8ce22f7e80cb85ad946cc82d198767b056366201d3e1a2b93d865be38154"
...
resolve_asset_filename() {
  ...
  if [ -z "${ASSET_FILENAME}" ]; then
    ASSET_FILENAME="age-${TAG}-${OS}-${ARCH}${EXT}"
  fi
}
...
execute() {
  ...
  BINARY_NAME='age-inspect'
  if [ -z "${EXT}" ] || [ "${EXT}" = ".exe" ]; then
    BINARY_PATH="${TMPDIR}/${ASSET_FILENAME}"
  else
    BINARY_PATH="${TMPDIR}/age/age-inspect"
  fi
  ...
  if [ -z "${EXT}" ] || [ "${EXT}" = ".exe" ]; then
    ...
    BINARY_PATH="${TMPDIR}/age/age-keygen"
  fi
  ...
  BINARY_NAME='age-plugin-batchpass'
  if [ -z "${EXT}" ] || [ "${EXT}" = ".exe" ]; then
    BINARY_PATH="${TMPDIR}/${ASSET_FILENAME}"
  else
    BINARY_PATH="${TMPDIR}/age/age-plugin-batchpass"
  fi
