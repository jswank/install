...
Usage: $this [-b bindir] [-d] [-q] [-n] [tag]
  ...
  -n turns on dry run mode
   ...
   If tag is missing, then v2.3.0 will be used.
...
EMBEDDED_CHECKSUMS="
2.2.0:validator-v2.2-darwin-amd64.tar.gz:641cc46e6aedf5a21bcf3c8be7d3a5ece785a0721b0f5d3fde525be73ff77a4d
2.2.0:validator-v2.2-darwin-arm64.tar.gz:89d78b62459d5eb80ad5693587cb4cd60918e109259d748c3d203e40f8ce5421
2.2.0:validator-v2.2-linux-386.tar.gz:5c17ecaaf5ed3c002d1a32a30824852060c7dad10c28b816d15dd5678496bcb0
...
resolve_asset_filename() {
  ...
  if [ -z "${ASSET_FILENAME}" ]; then
    ASSET_FILENAME="validator-v2.2-${OS}-${ARCH}${EXT}"
  fi
}
...
REPO='Boeing/config-file-validator'
EXT='.tar.gz'
